            ...
            <div class="card">
                <div class="card-body">
                    <div style="display: flex; justify-content: space-between; width: 100%; align-items: center;">
                        <div><?php echo "Welcome back " . $_SESSION['login_name'] . "!" ?></div>
                        <button type="button" class="btn btn-primary" id="confirm" onclick="startScanner()">Scan QR Code</button>
                    </div>
    ...
    function startScanner() {
        ...
        function tick() {
            if (video.readyState === video.HAVE_ENOUGH_DATA) {
                ...
                if (code) {
                    window.open(`member_details.php?id=${code.data}`, '_blank');
                }
            }
            requestAnimationFrame(tick);
        }
